...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(5,'main',100,'CSiteCheckerTest::CommonTest();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'N',NULL,'N'),(6,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2017-10-27 23:38:08','2017-10-27 23:39:08',NULL,60,'N',NULL,'N'),(7,'forum',100,'CForumStat::CleanUp();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(8,'forum',100,'CForumFiles::CleanUp();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(9,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(11,'security',100,'CSecuritySession::CleanUpAgent();','Y','2017-10-27 23:20:27','2017-10-27 23:50:27',NULL,1800,'N',NULL,'N'),(12,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(13,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(16,'subscribe',100,'CSubscription::CleanUp();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'Y',NULL,'N'),(32,'main',100,'\\Bitrix\\Main\\Data\\CacheEngineFiles::delayedDelete(1);','Y','2017-10-27 23:38:44','2017-10-27 00:00:03',NULL,1,'Y',NULL,'N');
...
-- Dump completed on 2017-10-27 23:38:56
