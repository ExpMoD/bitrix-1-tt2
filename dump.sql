...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2017-10-27 17:23:17','2017-10-28 00:00:00',NULL,86400,'Y',NULL,'N'),(5,'main',100,'CSiteCheckerTest::CommonTest();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'N',NULL,'N'),(6,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2017-10-27 23:30:13','2017-10-27 23:31:13',NULL,60,'N',NULL,'N'),(7,'forum',100,'CForumStat::CleanUp();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(8,'forum',100,'CForumFiles::CleanUp();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(9,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(11,'security',100,'CSecuritySession::CleanUpAgent();','Y','2017-10-27 23:20:27','2017-10-27 23:50:27',NULL,1800,'N',NULL,'N'),(12,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(13,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2017-10-27 17:23:17','2017-10-28 17:23:17',NULL,86400,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2017-10-27 22:47:53','2017-10-27 23:47:53',NULL,3600,'N',NULL,'N'),(16,'subscribe',100,'CSubscription::CleanUp();','Y',NULL,'2017-10-28 03:00:00',NULL,86400,'Y',NULL,'N'),(29,'main',100,'\\Bitrix\\Main\\Data\\CacheEngineFiles::delayedDelete(1);','Y','2017-10-27 23:30:49','2017-10-27 00:00:04',NULL,1,'Y',NULL,'N');
...
INSERT INTO `b_iblock_messages` VALUES (1,'ELEMENT_NAME','Новость'),(1,'ELEMENTS_NAME','Новости'),(1,'ELEMENT_ADD','Добавить новость'),(1,'ELEMENT_EDIT','Изменить новость'),(1,'ELEMENT_DELETE','Удалить новость'),(1,'SECTION_NAME','Раздел'),(1,'SECTIONS_NAME','Разделы'),(1,'SECTION_ADD','Добавить раздел'),(1,'SECTION_EDIT','Изменить раздел'),(1,'SECTION_DELETE','Удалить раздел'),(2,'ELEMENT_NAME','Элемент'),(2,'ELEMENTS_NAME','Товары'),(2,'ELEMENT_ADD','Добавить товар'),(2,'ELEMENT_EDIT','Изменить товар'),(2,'ELEMENT_DELETE','Удалить товар'),(2,'SECTION_NAME','Раздел'),(2,'SECTIONS_NAME','Разделы'),(2,'SECTION_ADD','Добавить раздел'),(2,'SECTION_EDIT','Изменить раздел'),(2,'SECTION_DELETE','Удалить раздел'),(3,'ELEMENT_NAME','Услуга'),(3,'ELEMENTS_NAME','Услуги'),(3,'ELEMENT_ADD','Добавить услугу'),(3,'ELEMENT_EDIT','Изменить услугу'),(3,'ELEMENT_DELETE','Удалить услугу'),(3,'SECTION_NAME','Раздел'),(3,'SECTIONS_NAME','Разделы'),(3,'SECTION_ADD','Добавить раздел'),(3,'SECTION_EDIT','Изменить раздел'),(3,'SECTION_DELETE','Удалить раздел'),(4,'ELEMENT_NAME','Вакансия'),(4,'ELEMENTS_NAME','Вакансии'),(4,'ELEMENT_ADD','Добавить вакансию'),(4,'ELEMENT_EDIT','Изменить вакансию'),(4,'ELEMENT_DELETE','Удалить вакансию'),(4,'SECTION_NAME','Раздел'),(4,'SECTIONS_NAME','Разделы'),(4,'SECTION_ADD','Добавить раздел'),(4,'SECTION_EDIT','Изменить раздел'),(4,'SECTION_DELETE','Удалить раздел'),(5,'SECTION_EDIT','Изменить раздел'),(5,'SECTION_ADD','Добавить раздел'),(5,'SECTIONS_NAME','Разделы'),(5,'SECTION_NAME','Раздел'),(5,'ELEMENT_EDIT','Изменить элемент'),(5,'ELEMENT_DELETE','Удалить элемент'),(5,'ELEMENT_ADD','Добавить элемент'),(5,'ELEMENTS_NAME','Элементы'),(5,'ELEMENT_NAME','Элемент'),(5,'SECTION_DELETE','Удалить раздел');
...
INSERT INTO `b_iblock_property` VALUES (1,'2017-10-27 14:23:27',2,'Специальное предложение','Y',100,'SPECIALOFFER',NULL,'L',1,30,'C','N','5',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(2,'2017-10-27 14:23:27',2,'Цена','Y',200,'PRICE',NULL,'N',1,30,'L','N','6',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(3,'2017-10-27 14:23:27',2,'Валюта цены (подпись)','Y',300,'PRICECURRENCY',NULL,'L',1,30,'C','N','7',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(4,'2017-10-27 14:23:27',2,'Габариты (Д х Ш х В)','Y',400,'SIZE',NULL,'S',1,30,'L','N','8',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(5,'2017-10-27 14:23:27',2,'Размеры спального места','Y',500,'S_SIZE',NULL,'S',1,30,'L','N','9',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(6,'2017-10-27 14:23:27',2,'Артикул','Y',600,'ARTNUMBER',NULL,'S',1,30,'L','N','10',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(7,'2017-10-27 14:23:27',2,'Материал','Y',700,'MATERIAL',NULL,'S',1,30,'L','N','11',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(8,'2017-10-27 14:23:27',2,'Производитель','Y',800,'MANUFACTURER',NULL,'S',1,30,'L','N','12',NULL,5,NULL,NULL,'N','N','N','N',1,NULL,NULL,NULL),(9,'2017-10-27 20:22:05',5,'Должность','Y',500,'POSITION','','S',1,30,'L','N','9','',5,NULL,0,'N','N','Y','N',1,NULL,NULL,''),(10,'2017-10-27 20:22:05',5,'Компания','Y',500,'COMPANY','','S',1,30,'L','N','10','',5,NULL,0,'N','N','N','N',1,NULL,NULL,'');
...
INSERT INTO `b_search_content_title` VALUES (55,'s1',0,'CЕРГЕЙ'),(15,'s1',39,'DEL'),(15,'s1',43,'MOBILE'),(15,'s1',33,'SALON'),(27,'s1',0,'АЛАДДИН'),(56,'s1',5,'АНДРЕЕВА'),(56,'s1',0,'АННА'),(52,'s1',0,'АНОНСЫ'),(53,'s1',0,'АРХИВ'),(14,'s1',16,'БЕЛАРУСИ'),(49,'s1',0,'БУХГАЛТЕР'),(5,'s1',0,'ВАКАНСИИ'),(40,'s1',0,'ВАЛЕНСИЯ'),(16,'s1',17,'ВОДОСТОЙКОЕ'),(7,'s1',0,'ВХОД'),